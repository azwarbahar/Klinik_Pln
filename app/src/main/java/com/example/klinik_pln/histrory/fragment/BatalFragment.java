...
public class BatalFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void LoadallData(String nama) {
        ...
        Call<List<getDataAntrianOneModel>> listCall = apiRequestAntrian.read_antrian_user_status(nama, "Batal");
