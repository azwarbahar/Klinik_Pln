...
public class AllAntrianFragmentPertama extends Fragment implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    private void LoadallData() {
        ...
        final Call<ResponsModelTambah> getallAntrian = apiRequestAntrian.getdataantrian(jamKerja);
