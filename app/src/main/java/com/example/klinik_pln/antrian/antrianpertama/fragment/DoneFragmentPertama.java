package com.example.klinik_pln.antrian.antrianpertama.fragment;
...
public class DoneFragmentPertama extends Fragment implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    private void loadData(){
        ...
        Call<ResponsModelTambah> getDataantrian = apiRequestAntrian.getAllmenunggu(tanggal,jamKerja,status);
        getDataantrian.enqueue(new Callback<ResponsModelTambah>() {
            ...
            public void onResponse(Call<ResponsModelTambah> call, Response<ResponsModelTambah> response) {
                ...
                if (kode.equals("1")){
                    ...
                    Toast.makeText(getContext(), "Gagal Read Data", Toast.LENGTH_SHORT).show();
